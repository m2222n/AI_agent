      ...
      <div className="mx-auto flex max-w-3xl items-center gap-1 overflow-x-auto px-3 py-2 sm:px-4">
        ...
        {onMenuClick && (
          <button
            ...
            aria-label="메뉴 열기"
            onClick={onMenuClick}
            className="shrink-0 rounded-lg px-2 py-1.5 text-base text-gray-600 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-800 lg:hidden"
          >
            ☰
          </button>
        )}
          ...
          {loading ? null : user ? (
            <>
              ...
              <button
                type="button"
                onClick={logout}
                className="shrink-0 rounded-lg px-3 py-1.5 text-xs text-gray-600 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-800"
              >
                로그아웃
              </button>
            </>
