...
def test_all_tools_list():
    ...
    assert names == {"search_etf", "compare_etfs", "get_etf_list", "search_stock", "compare_stocks", "get_stock_list", "get_realtime_price", "analyze_sector", "get_technical_indicators", "get_stock_correlation", "simulate_portfolio", "get_financial_statements", "predict_price_outlook"}
