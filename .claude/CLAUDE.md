...
_Last Updated: 2026-04-23 (UI/UX 2차: 탭 순서 변경, 재무제표 카드, 단계별 로딩, 사이드바 연동, 홈 버튼 탭 리셋, X축 연도 라벨, days 파라미터 파이프라인, 차트 기준일 연도, 사이드바 잘림 수정+업데이트 안내. 도구 13개, 테스트 431개, eval 162개, Hit Rate 100%)_
