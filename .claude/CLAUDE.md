...
_Last Updated: 2026-06-29 (PR #102 — 임베딩 비교 정식화: BGE-M3 vs OpenAI 실측. full 파이프라인 천장이라 현행 small 유지, dense는 large 압도. + RAG 검색 품질 CI 게이트(run_eval --min-hit-rate + ci.yml rag-eval, OPENAI_API_KEY secret 있을때만). 백엔드 873)_
