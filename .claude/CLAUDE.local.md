...
_Last Updated: 2026-06-24 (비교분석 1주/1개월/3개월 추가 #79 + 관심종목 종목명 #78 + 시세 정확성 실버그 2건 #77(시장구분·기간등락률) + #76 사이드바 전체검색·관심탭 + 가상투자 #69~71·#75 + 신규종목 제외 #72·#73 + 대문자티커 #74 + Railway Hobby. ⚠️프로덕션 백엔드가 #77~78 미배포 상태로 추정(로컬·main은 정상, days=120인데 prod는 data_days=250 옛코드) → 사용자 Railway 백엔드 수동 재배포 필요. 다음: 후원/블로그9편)_
