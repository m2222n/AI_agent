...
### 동원 가능 풀 (한국 갤럭시 점유율 60~70% → 지인 20명 중 12~14명 가능성)
회사(오리누) 동료 / 가족·친척(이탈 위험 최저) / 대학 동기·선후배 / **친구 재우**(앱화는 하차했으나 테스터로는 가능, 삼성 노트북 유저라 폰도 갤럭시 가능성).
...
- **실행 권장**: 카페 + 테스트잇 + 지인을 **병행**해 15~16명 확보(단일 채널 의존 금지 — 이탈 1명이면 리셋).
