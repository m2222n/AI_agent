...
_Last Updated: 2026-06-24 (#2 근본해결 #82 — 프로덕션 DB가 일일수집 1년치뿐(full 미다운)이라 기간가격 동일했던 것: ensure_db에 깊이검증(_is_full_depth<300만행→full 재다운). 강점=12년 시계열 복구. + 종목클릭 #80 + high/low필터 #81 + 비교단기 #79 + 관심종목명 #78 + 시세정확성 #77. 전체 837. ⚠️사용자: 백엔드 재배포→full DB(1.7GB) 받음. 영구볼륨 없어 재배포마다 재다운(DEPLOY.md 영속볼륨 권장). 다음: 후원/블로그)_
