...
_Last Updated: 2026-06-24 (관심종목 종목명 표시 #78 + 시세 정확성 실버그 2건 #77(시장구분 .KS/.KQ·기간등락률) + 기간대비등락률·사이드바 전체검색·관심탭 #76 + 가상투자 #69~71·주문UX #75 + 시세부족 신규종목 제외 #72·#73 + 영문대문자 티커 #74 + Railway Hobby 유료전환. 전체 835. git push HTTP/1.1 우회. ⚠️KOSDAQ market 백필은 pykrx 외부장애로 보류(fallback이 보강). 다음: 후원/블로그9편)_
